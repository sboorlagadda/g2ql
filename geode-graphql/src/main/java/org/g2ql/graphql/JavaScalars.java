...
public class JavaScalars {
  ...
  public static GraphQLScalarType GraphQLLocalDateTime =
      new GraphQLScalarType("LocalDateTime", "Date type", new Coercing() {
        @Override
        ...
        private LocalDateTime parseLongToLocalDateTime(long input) {
          return LocalDateTime.ofInstant(Instant.ofEpochSecond(input),
  ...
  public static GraphQLScalarType GraphQLInstant =
      new GraphQLScalarType("Instant", "Date type", new Coercing<Instant, Long>() {
        ...
        public Instant parseValue(Object input) {
          ...
          throw new CoercingSerializeException("Expected type 'Long' or 'Integer' but was '"
  ...
  public static GraphQLScalarType GraphQLLocalDate =
      new GraphQLScalarType("LocalDate", "Date type", new Coercing() {
        @Override
        public Object serialize(Object input) {
          if (input instanceof String) {
  ...
  public static GraphQLScalarType GraphQLDate =
      new GraphQLScalarType("Date", "Date type", new Coercing() {
  ...
  public static GraphQLScalarType GraphQLUUID =
      new GraphQLScalarType("UUID", "UUID type", new Coercing() {
